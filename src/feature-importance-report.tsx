...
import FeatureImportanceGraph from './charts-components/feature-importance-graph';
...
class FeatureImportanceReport extends PureComponent<IProps, IState> {
  private readonly type: string = REPORTTYPE.FEATURE_IMPORTANCE_REPORT;
  ...
  renderReport = (report: IState['currentReport'], algorithm: IState['algorithm']): ReactNode => {
    const currentReport = transImportanceReport(report, algorithm);
    return (<FeatureImportanceGraph report={currentReport} type={algorithm} />);
  }
...
export default FeatureImportanceReport;
// const Component1: React.FC<any> = (props) => {
//   return <div >测试外部通讯</div>
// }
